...
;/*                                                                                                         */
;/*-----------------------------------------------------------------------------------------------------------
;  File Name        : startup_ht32f5xxxx_03_iap.s
;  Version          : $Rev:: 3927         $
...
;*******************************************************************************
                  ...
                  IF (USE_HT32_CHIP=HT32F0008)
                    AREA    |.ARM.__AT_0x000001A4|, CODE, READONLY  ;IAP UART SETTING: Vector address of UART0
                  ENDIF
                  IF (USE_HT32_CHIP=HT32F52344_54)
                    AREA    |.ARM.__AT_0x200001A8|, CODE, READONLY  ;IAP UART SETTING: Vector address of UART1
                  ENDIF
                  IF (USE_HT32_CHIP=HT32F52357_67)
                    AREA    |.ARM.__AT_0x200001A0|, CODE, READONLY  ;IAP UART SETTING: Vector address of UART1
                  ENDIF
                    IMPORT  UxART_IRQHandler
                    DCD     UxART_IRQHandler
