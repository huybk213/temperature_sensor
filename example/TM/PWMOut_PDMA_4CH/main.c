...
void TM_InitPWMData(void)
{
  ...
  CCR_Buffer[0] = uCounterReload * LOW_PERIOD;
  CCR_Buffer[1] = uCounterReload * HIGH_PERIOD;
  CCR_Buffer[2] = uCounterReload * LOW_PERIOD;
  CCR_Buffer[3] = uCounterReload * HIGH_PERIOD;

  CCR_Buffer[4] = uCounterReload * HIGH_PERIOD;
  CCR_Buffer[5] = uCounterReload * LOW_PERIOD;
  CCR_Buffer[6] = uCounterReload * HIGH_PERIOD;
  CCR_Buffer[7] = uCounterReload * LOW_PERIOD;

  CCR_Buffer[8]  = uCounterReload * HIGH_PERIOD;
  CCR_Buffer[9]  = uCounterReload * HIGH_PERIOD;
  CCR_Buffer[10] = uCounterReload * LOW_PERIOD;
  CCR_Buffer[11] = uCounterReload * LOW_PERIOD;
}
