/*********************************************************************************************************//**
 * @file    USBD/Mass_Storage_IAP/Src_IAP/iap_usb_bulk_only_transport.c
 * @version $Rev:: 4860         $
...
#include "iap_usb_scsi_block_command.h"
#include "iap_flash_disk.h"
...
static BOT_Media_TypeDef gMediaInfo[BOT_LUN_NUM] =
{
  {
    FLASH_DISK0_ID,
    {FLASH_DISK0_BlockCount, FLASH_DISK0_BlockSize, FLASH_DISK0_MemorySize, IAP_FLASH_START, IAP_FLASH_SIZE},
    (pInit)FLASH_DISK_Init,
    (pReadFun)FLASH_DISK_Read,
    (pWriteFun)FLASH_DISK_Write,
    (pGetStatusFun)FLASH_DISK_GetStatus,
    NULL,
    NULL,
  },
};
...
void BOT_Init(void)
{
  ...
  SBC_Init(GET_MEDIA(0), 0);
  gMediaInfo[0].Init(gMediaInfo[0].uId, &(gMediaInfo[0].Size));
